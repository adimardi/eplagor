            		...
            		<div class="col-12">
				            ...
				            <table class="table table-bordered table-resposive table-sm order-column nowrap align-items-center mb-0">
				              	<thead>
				                	...
				                	<tr>
				                  		...
				                  		<th class="text-uppercase font-weight-bolder p-2">
					                  		<div class="input-group input-group-static mb-0">
												<input type="text" name="namaSatker" class="form-control" placeholder="Nama Satker" onfocus="focused(this)" onfocusout="defocused(this)" required="">
											</div>	
				                  		</th>
				                	</tr>
				                	<tr>
				            ...
				            <table class="table table-bordered table-resposive table-sm order-column nowrap align-items-center mb-0">
				              	<thead>
				                	...
				                	<tr class="bg-success" style="color: #ffffff;">
				                		<th class="text-uppercase font-weight-bolder" colspan="5">Perkara Pidana</th>
				                	</tr>
				                	<tr>
				                	...
				                	<tr>
				                  		<th class="text-uppercase font-weight-bolder" width="200px">
				                  			Pidana Biasa dan Pidana Singkat
				                  		</th>
				                	...
				                	<tr class="bg-success" style="color: #ffffff;">
				                		<th class="text-uppercase font-weight-bolder" colspan="5">Perkara Perdata</th>
				                	</tr>
				                	<tr>
				                		<th class="text-uppercase font-weight-bolder" width="200px">Jenis Perkara</th>
				                  		<th class="text-uppercase font-weight-bolder text-center" width="200px">Tahun 1</th>
				        ...
				        <div class="table-responsive p-2">
				            <table class="table table-bordered table-resposive table-sm order-column nowrap align-items-center mb-0">
				              	<thead>
				              		<tr class="bg-gradient-primary" style="color: #ffffff;">
				                		<th class="text-uppercase font-weight-bolder" colspan="5">Unsur Penunjang</th>
				                	</tr>
				                	<tr>
				                		...
				                		<th class="text-uppercase font-weight-bolder text-center">Penerapan RB</th>
				                		<th class="text-uppercase font-weight-bolder text-center">Letak Pengadilan</th>
				                	</tr>
				                	<tr>
				                		...
				                		<th class="text-uppercase font-weight-bolder text-center" width="100px">
				                  			<div class="input-group input-group-static mb-0">
												<input type="text" name="komunikasi" class="form-control text-center" placeholder="Komunikasi & Transportasi" onfocus="focused(this)" onfocusout="defocused(this)">
											</div>
				                  		</th>
				                		<th class="text-uppercase font-weight-bolder text-center" width="100px">
				                  			<div class="input-group input-group-static mb-0">
												<input type="text" name="penerapanRb" class="form-control text-center" placeholder="Penerapan RB" onfocus="focused(this)" onfocusout="defocused(this)">
											</div>
				                  		</th>
				                		<th class="text-uppercase font-weight-bolder text-center" width="100px">
				                  			<div class="input-group input-group-static mb-0">
												<input type="text" name="letakPengadilan" class="form-control text-center" placeholder="Letak Pengadilan" onfocus="focused(this)" onfocusout="defocused(this)">
											</div>
				                  		</th>
				                	</tr>
				              	</thead>
