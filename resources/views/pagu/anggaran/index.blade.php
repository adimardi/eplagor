  	...
  	$.fn.dataTable.ext.errMode = 'throw';
      	...
      	.DataTable({
          	...
          	columns: [
                      	...
                      	{ data: 'satker', sClass: "text-secondary mb-0 text-start"},
                        ...
                        { data: 'action', sClass: "text-secondary mb-0 text-center", width: "50px"},
                  	],
          	fixedColumns: {
                    leftColumns: 0,
                    rightColumns: 0
          ...
          <div class="row p-3">
            <div class="col-12">
              <div class="table-responsive p-3">
                <table id="tablePagu" class="table table-bordered table-hover table-resposive order-column nowrap align-items-center mb-0" width="100%">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-center font-weight-bolder">No</th>
                      ...
                      <th class="text-uppercase text-secondary text-center font-weight-bolder">Tahun</th>
                      <th class="text-center text-uppercase text-secondary font-weight-bolder">Belanja Pegawai</th>
                      <th class="text-center text-uppercase text-secondary font-weight-bolder">Belanja Barang</th>
                      <th class="text-center text-uppercase text-secondary font-weight-bolder">Belanja Modal</th>
                      <th class="text-uppercase text-secondary text-center font-weight-bolder">Total</th>
