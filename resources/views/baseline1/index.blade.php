		            	...
		            	<div class="col-12">
		            		...
		            		<div class="dropdown">
								...
								<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
		                    		...
		                    		<li><a class="dropdown-item text-secondary" href="{{ route('baseline1.create') }}">Opsi 2 (Menginput Pagu Baru)</a></li>
								</ul>
							</div>
				                		...
				                		<div class="row">
				                  			...
				                  			<div class="col-md-4">
				                    			...
				                    			<div class="input-group input-group-static mb-2">
				                      				...
				                      				<input type="number" id="volume2" name="volume2" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" required="">
				                  			...
				                  			<div class="col-md-4">
				                    			...
				                    			<div class="input-group input-group-static mb-2">
				                      				...
				                      				<input type="number" id="volume3" name="volume3" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" required="">
				                    			...
				                    			<div class="input-group input-group-static mb-2">
							                      	...
							                      	<input type="number" id="volume4" name="volume4" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)" required="">
