...
class dataStatusAnggaran extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'apikeu:dataStatusAnggaran';
    ...
    public function handle()
    {
        ...
        foreach ($reffsatkers as $reffsatker){
            ...
            ApiJobStatusAnggaran::dispatch($options, $kodeSatker);
        }

        \logAktifitas::addToLog('Tarik API Data Status Anggaran');
