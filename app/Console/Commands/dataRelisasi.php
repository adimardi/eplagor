...
class dataRelisasi extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'apikeu:dataRealisasi';
    ...
    public function handle()
    {
        ...
        foreach ($reffsatkers as $reffsatker){
            ...
            ApiJobRealisasiAnggaran::dispatch($options, $kodeSatker);
        }

        \logAktifitas::addToLog('Tarik API Data Realisasi Anggaran');
