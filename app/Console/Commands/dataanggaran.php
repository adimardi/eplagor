...
class dataanggaran extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'apikeu:dataanggaran';
    ...
    public function handle()
    {
        ...
        foreach ($reffsatkers as $reffsatker){
            ...
            ApiJobAnggaran::dispatch($options, $kodeSatker);
        }

        \logAktifitas::addToLog('Tarik API Data Anggaran');
